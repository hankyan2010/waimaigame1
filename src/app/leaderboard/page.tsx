  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col">
      <div className="bg-brand pt-6 pb-10 px-6 rounded-b-[2rem] relative">
        <button
          onClick={() => router.back()}
          className="absolute left-4 top-5 text-xs font-bold text-title/70"
        >
          ← 返回
        </button>
        <div className="text-center">
          <div className="text-3xl mb-1">🏆</div>
          <h1 className="text-xl font-black text-title">外卖老板英雄榜</h1>
          <p className="text-xs text-title/70 mt-1">
        ...
        <div className="bg-card rounded-2xl shadow-sm overflow-hidden">
          {!hydrated ? (
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-sm font-bold text-title">榜单还是空的</p>
